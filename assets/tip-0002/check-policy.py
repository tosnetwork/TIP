...
"""Check TIP-0002 policy examples; supplied booleans are NOT PQ signatures.

This model has no cryptographic implementation and does not run TOS consensus.
It exercises phase authorization, certificate membership and weighted quorum.
"""
